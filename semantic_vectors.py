...
SEMANTIC_GROUPS = {
    "placanje_kirije": {
        "weight": 0.18,
        "templates": [
            "plaćanje kirije za {mesec}",
            "kirija za {mesec}",
            "uplata zakupnine za {objekat}",
            "stanarina za {mesec}",
            "mesečna kirija za {objekat}",
            "plaćanje najma za {objekat}",
        ],
    ...
    "neobican_transfer": {
        ...
        "templates": [
            "neobičan transfer",
            "neuobičajen prenos sredstava",
            "transfer po hitnom dogovoru",
            "specijalan prenos bez standardne osnove",
            "prenos po internom dogovoru",
        ],
